...
public class GetObjectResponseIteratorTest extends TestCase {
	...
	public void testIterationMultipart() throws Exception {
		...
		GetObjectResponse getObjectResponse = new GetObjectResponse(headers, new ByteArrayInputStream(MULTIPART_RESPONSE_BODY), null);
	...
	public void testMissingObjects() throws Exception {
		...
		GetObjectResponse getObjectResponse = new GetObjectResponse(headers, BUG_MULTIPART_RESPONSE_BODY, null);
	...
	public void testCaseInsensitiveHeaders() throws Exception {
		...
		headers.put("content-id", "one");
		headers.put("Object-id", "1");
		GetObjectResponse getObjectResponse = new GetObjectResponse(headers, new ByteArrayInputStream(BINARY_BLOB_1.getBytes()), null);
